...
const AboutInfo = () => {
    return (
        <section id="about__section-2" className="about__info">
            <div className="l-700">
                <div className="about__info-text">
                    <h2 className="heading-xlarge text--light">
                        Design<br />
                    Build <br />
                    Learn
                </h2>
                    <p className="text--light text--lead">
                ...
                <div className="about__info-image">
                    <img src={building} alt="White square building" className="building" />
                </div>
            </div>
        </section>
    )
